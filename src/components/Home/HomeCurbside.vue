      ...
      <div class="bg-gray-50">
        <div class="py-20 px-4 sm:px-5 2xl:px-8 2xl:container">
            ...
            <div class="text-left max-w-prose">
              ...
              <p class="mt-3 text-xl text-gray-500 sm:mt-4">
                We’re currently just offering curbside pickup.
              </p>


              <p class="mt-3 text-xl text-gray-500 sm:mt-4">
                Orders ready in as little as 1 Hour. (Order by 8:30 PM for same day)
              </p>

              <p class="mt-3 text-xl text-gray-500 sm:mt-4">
                Curbside Pickup Available Daily from 11:00 AM - 9:30 PM.
              </p>
