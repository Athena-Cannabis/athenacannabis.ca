        ...
        <div class="pt-10 pb-48 w-full lg:w-2/3 mx-auto text-center">
          ...
          <p class="text-center mt-10">
            <a
              ...
              font-medium rounded-sm text-white bg-brand-blue-800 hover:bg-brand-blue-900
            ...
            <router-link
              ...
              font-medium rounded-sm text-brand-blue-800 bg-gray-100 hover:bg-brand-blue-700 hover:text-gray-100
              focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500
              transition-all duration-150 ease-in-out">
