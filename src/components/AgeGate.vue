  ...
  <div class="w-full sm:min-h-screen flex justify-center items-center
    ...
    <div class="sm:w-3/4 md:w-3/5 lg:w-1/2 2xl:w-2/5 bg-white
      ...
      <div class="">
        ...
        <h1
          class="mt-5 text-xl sm:text-3xl font-medium text-gray-800">
          Hi there,
          <span class="sr-only">Welcome to Athena Cannabis</span>
        </h1>

        <p class="mt-5 text-gray-600 text-sm sm:text-base">You must be 19 years of age or older to view and purchase recreational cannabis products in the province of Ontario.</p>


        <p class="mt-5 text-gray-600 text-sm sm:text-base">Before we can let you in, we need to ask you to verify your age so that we can ensure you are old enough to enter the site.</p>


        <!-- <p class="mt-5 text-gray-600">You must verify that you are 19 years of age or older to enter this site.</p> -->
        ...
        <form
          ...
          <h2
            class="font-medium text-lg sm:text-2xl text-gray-900">
            When were you born?
          </h2>

          <div class="mt-5 grid grid-cols-3 gap-6">
            <label for="day" class="block">
              <span class=" text-gray-700 text-lg">Day</span>
              <input
                type="number"
                id="day"
                name="day"
            ...
            <label for="year" class="block">
              <span class="text-gray-700 text-lg">Year</span>
              <input
                type="number"
                id="year"
                name="year"
...
export default {
  setup() {
    ...
    // Bypass agegate if crawler
    useCrawlerCheckAgeGateBypass();
