<template>
  <div class="w-full min-h-screen bg-gray-50 flex justify-center items-center">
    <div class="container lg:w-1/2 2xl:w-1/3 bg-white
      ...
      <div class="">
        ...
        <p class="mt-5">Aenean eu varius ligula. Fusce vel lorem sollicitudin dolor rutrum pharetra. Phasellus id dolor sed ligula gravida euismod et id eros.</p>
              ...
              <span class=" text-gray-700">Day</span>
               <input
                ...
                class="mt-1 block w-full rounded-md bg-gray-100 border-transparent
                    focus:border-gray-200 focus:bg-gray-50 focus:ring-0" />
            </label>
          ...
          <div class="my-5">
            <button
              ...
              class="w-full bg-gray-400 text-white py-5 rounded-xl
                    text-xl font-medium
                    hover:bg-gray-600
                    focus:outline-none focus:ring-2 focus:border-black focus:bg-black
